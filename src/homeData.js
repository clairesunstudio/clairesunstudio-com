module.exports =
  [
    ...
    {'url': 'fashion', 'name': 'fashion', 'sort': 4, 'key': 4, 'description': 'An interactive data visualization built with D3.js'},
    {'url': 'map', 'name': 'map', 'sort': 5, 'key': 5, 'description': 'An interactive data visualization built with D3.js'},
    {'url': 'freshmedia1', 'name': 'fresh media Part I', 'sort': 6, 'key': 6, 'description': 'Sensor Light Installation at the Fresh Media Show'},
    {'url': 'freshmedia2', 'name': 'fresh media Part II', 'sort': 6, 'key': 7, 'description': 'Sensor Light Installation at the Fresh Media Show'},
